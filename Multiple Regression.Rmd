...
The plot above dictated that our data did not have normally distributed errors. To confirm this formally, we conducted a Shapiro-Wilk test:
...
We also considered the variables with negative coefficients that we outlined previously. YR_RMDL was already tested because of it's high p-value but we tested dropping BEDRM as well. This resulted in a lower R^2, so we decided to keep the variable for the model.

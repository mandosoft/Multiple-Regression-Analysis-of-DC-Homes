...
cor(houses$HF_BATHRM, houses$BATHRM, houses$ROOMS, houses$BEDRM, houses$AYB, houses$YR_RMDL, houses$PRICE, houses$SALEDAY, houses$SALEMONTH, houses$SALEYEAR, houses$STORIES, houses$LANDAREA, houses$GBA, houses$CNDTN, houses$PRICE)

# Use corrplot to display a correlation matrix of that variables
library(corrplot)
corr_matrix <- cor(houses$HF_BATHRM, houses$BATHRM, houses$ROOMS, houses$BEDRM, houses$AYB, houses$YR_RMDL, houses$PRICE, houses$SALEDAY, houses$SALEMONTH, houses$SALEYEAR, houses$STORIES, houses$LANDAREA, houses$GBA, houses$CNDTN, houses$PRICE)
corrplot(houses, type = "upper", order = "hclust", 

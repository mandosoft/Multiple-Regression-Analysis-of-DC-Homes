...
$\widehat{Y} = -49280 + 56.94X + 35.80X_2 + -38.24X_3 + 112.40X_4 + 60.61X_5 + 3.52X_6 + 1.44X_7 + 25.00X_8 + 14.45X_9 + -99.70X_{10} + 403.7X_{11} + 85.75X_{12} + 65.30X_{13} + 14.83X_{14} + .049\varepsilon$


## Application of the Model

At the beginning of our analysis, we removed five records to test our final model, once we had it established. 
